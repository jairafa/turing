...
class masivos(models.Model):
    tarea = models.CharField(max_length=150, blank=True, null=True)
    ...
    identificador = models.CharField(max_length=25, blank=True, null=False)
    tipo_identificador = models.CharField(max_length=25, blank=True, null=False)
...
class tipo_masivo(models.Model):  # radicaciones_tipo_masivo
    ...
    tarea = models.CharField(max_length=120, blank=True, null=True)
...
class masivos_file(models.Model):
    ...
    archivo = models.FileField(upload_to="reports/%Y/%m/", blank=True, null=True)
...
class masivos_file_adjunto(models.Model):
    ...
    observaciones = models.CharField(max_length=2000, blank=True, null=True)
    archivo = models.FileField(upload_to="reports/adjuntos/%Y/%m/", blank=True, null=True)
